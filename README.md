...
[![Version](https://img.shields.io/badge/Version-0.0.0P-green)](https://github.com/Mursisru/NOCS)
...
* **Mission-only bootstrap:** Harmony patches attach on the first mission scene (not main menu).
...
**Keywords:** Nuclear Option, BepInEx, Harmony, mod, countermeasures, notch, radar jam, ASE, anti-missile, hard-kill, flight HUD, Configuration Manager, QoL
